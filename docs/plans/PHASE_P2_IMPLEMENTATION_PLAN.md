...
> **Plan status:** `P2_PLAN_REVIEW=P2_PLAN_REVIEW_PASS` · `P2_IMPLEMENTATION_PLAN=FROZEN` · `P2_PLAN_FROZEN=YES` · `IMPLEMENTATION_AUTHORIZED=NO` · `P2_IMPLEMENTATION=NOT_STARTED`
...
- `P2_IMPLEMENTATION_PLAN=FROZEN`；`P2_PLAN_REVIEW=P2_PLAN_REVIEW_PASS`；`P2_PLAN_FROZEN=YES`；计划本身不构成 `IMPLEMENTATION_AUTHORIZED`、`REVIEW_PASS`、`ACCEPTED`、merge 或 push 授权。
...
```text
P2_IMPLEMENTATION_PLAN=FROZEN
P2_PLAN_REVIEW=P2_PLAN_REVIEW_PASS
P2_PLAN_FROZEN=YES
